...
- BLOCK 15 is active for upload/API integration behind an internal gate. Features 15.1, 15.2, 15.3, 15.4, and 15.4.1 are implemented / ready for review; debug inspection view planning is next.
