...
- BLOCK 12 is the current in-progress internal/test-only role/color classifier experiment block.
...
- Current step is 12.3 test-only color classifier experiment implemented / ready for review.
