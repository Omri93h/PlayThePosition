...
## UX principles
- Zero friction from upload to board.
- No unnecessary confirmation screen.
- Board-first interface.
- Edit mode must be obvious and reliable.
- Failures must explain what went wrong and how to retry.

## Product promise
From screenshot to playable chess position in seconds.
