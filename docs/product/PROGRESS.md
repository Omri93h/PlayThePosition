...
- Current focus: BLOCK 09 — Real Recognition Fixture Intake and Measurements, Feature 9.4 ready for review.
...
- Review 9.4 Run fixture-gated board-bounds measurements.
- Do not start piece recognition measurements until explicitly approved in 9.5 or later.
